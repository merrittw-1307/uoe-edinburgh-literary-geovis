...
% TODO: revisit priority against the user-study-dependent chapters once the study itself has run in Week 7; the outer sentence-level detail panel is the main remaining item if time allows.
