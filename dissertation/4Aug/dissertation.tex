...
% DRAFT -- please review and extend with any personal thanks before submission.
I would like to thank my supervisor, Uta Hinrichs, for her guidance throughout this project and for her consistently detailed feedback on every iteration of the six visualisation prototypes. This project builds on the LitLong Edinburgh dataset, and I thank the LitLong research team for making it available. Finally, I thank the participants of the user study for their time and insight.
...
% TODO: revisit priority against the user-study-dependent chapters once the study itself has run in Week 7. Everything planned for the combined interface (author selector, cross-view linking, outer detail panel, metro snapshot coverage, and the performance/legibility fixes above) is now implemented; no further combined-interface work is scoped unless the study surfaces a need.
...
\textbf{Task 2 --- narrative/geographic relationship (shown once per topology design: force-directed network, linear connection diagram, metro map).}
\begin{enumerate}
  ...
  \item Did the visualisation give you any sense of \emph{why} these two places might be connected in the way it shows? \emph{(free text, optional)}
\end{enumerate}
